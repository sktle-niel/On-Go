...
/// * **Console website** (the `On-Go-Console` repository, Flutter web) —
///   Admin and Moderator.
///
/// They are separate applications that meet at the On Go API. This package is
/// that meeting point: the DTOs that cross the wire, and the interfaces each
/// side codes against. Nothing here knows about HTTP, Flutter, or a database,
/// so both apps — and the server — can depend on it.
///
...
export 'src/api/points_wallet_api.dart';
export 'src/api/rank_policy_api.dart';
export 'src/api/service_request_api.dart';
...
export 'src/models/points_wallet.dart';
